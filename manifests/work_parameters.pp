...
class set_vnx{
  $serial = "CKM00121900536"
  $spa = "10.62.0.133"
  $spb = "10.62.0.134"
  $username = "sysadmin"
  $password = "sysadmin"
  $result_file = "/tmp/completed_commands.log"
}

class set_vnx_params{
...
#  ]
 ...
 # ]
  ...
  $lunlist = [
    #Type, Capacity, Size qualifier, Pool Name, SP, LUN Number(ALU), Threshhold, Name
    # "thin,10,gb,FreePool000,a,411,true",
    "thin,104857600,bc,FreePool000,b,412,true,LUN412",
    "thin,104857600,bc,FreePool000,a,413,true,LUN413",
    "thin,104857600,bc,FreePool000,b,414,true,LUN414"
  ]
...
#  ]
  ...
  $sglun = [
    ...
    "emc-Cluster01b,412,32",
    "emc-Cluster01c,413,33",
