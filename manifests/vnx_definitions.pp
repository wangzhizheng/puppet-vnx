class vnx_transport{
  ...
  transport { 'VNX':
    server => $set_vnx::spa,
    username => $set_vnx::username,
    password => $set_vnx::password,
  }
}
...
#  }
  ...
  define vnx_createSG{
    ...
    exec { "vnx_createSG $name result":
      command => "echo `date` : vnx_createSG $name >> $set_vnx::result_file",
      path => "/bin/",
      refreshonly => true
    }
  }
  ...
  define vnx_addLUN{
    ...
    exec { "vnx_addLUN $name result":
      command => "echo `date` : vnx_addLUN $name >> $set_vnx::result_file",
      path => "/bin/",
      refreshonly => true
    }
  }
...
#  }
  ...
  define vnx_addHost{
    ...
    exec { "vnx_addHost $name result":
      command => "echo `date` : vnx_addHost $name >> $set_vnx::result_file",
      path => "/bin/",
      refreshonly => true
    }
  }
